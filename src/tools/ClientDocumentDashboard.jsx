...
const MOCK_CLIENTS = [
  ...
  },
  {
    ...
    returnType: 'Personal',
    items: [
      mockItem('c1',  'Income', 'W-2s (all employers)', 'Detected', '', 'David_W2_Employer_2025.pdf'),
      mockItem('c2',  'Income', '1099 forms (NEC, MISC, K, INT, DIV, B)', 'Detected', '', 'chen_1099_consolidated.pdf'),
      mockItem('c3',  'Income', 'Self-employment / side income details', 'Not Started'),
      mockItem('c4',  'Income', 'Rental income (long-term / short-term)', 'N/A'),
      mockItem('c5',  'Income', 'K-1s (partnerships / S-corps)', 'Not Started'),
      mockItem('c6',  'Business & Rentals', 'Business/entity type', 'N/A'),
      mockItem('c7',  'Business & Rentals', 'Profit & Loss statement', 'N/A'),
      mockItem('c8',  'Business & Rentals', 'Major expenses & payroll details', 'N/A'),
      mockItem('c9',  'Business & Rentals', 'Asset purchases (vehicles, equipment, property)', 'N/A'),
      mockItem('c10', 'Business & Rentals', 'Depreciation schedules', 'N/A'),
      mockItem('c11', 'Business & Rentals', 'Short-term rental details', 'N/A'),
      mockItem('c12', 'Real Estate', 'Closing statements (HUD / CD)', 'N/A'),
      mockItem('c13', 'Real Estate', 'Mortgage interest statements (1098)', 'Detected', '', 'mortgage_interest_2025.pdf'),
      mockItem('c14', 'Real Estate', 'Property tax statements', 'Detected', '', 'property_tax_bill_2025.pdf'),
      mockItem('c15', 'Real Estate', 'Repairs vs improvements list', 'N/A'),
      mockItem('c16', 'Real Estate', 'Cost segregation study (if applicable)', 'N/A'),
      mockItem('c17', 'Deductions & Credits', 'Retirement contributions', 'Detected', '', 'IRA_contribution_2025.pdf'),
      mockItem('c18', 'Deductions & Credits', 'HSA contributions', 'N/A'),
      ...
      mockItem('c22', 'Vehicles & Travel', 'Business-use vehicles', 'N/A'),
      mockItem('c23', 'Vehicles & Travel', 'Mileage logs', 'N/A'),
      mockItem('c24', 'Vehicles & Travel', 'Auto purchase/lease info', 'N/A'),
      mockItem('c25', 'Vehicles & Travel', 'Business/rental travel expenses', 'N/A'),
      mockItem('c26', 'Tax Planning', 'Estimated tax payments', 'Not Started'),
      mockItem('c27', 'Tax Planning', 'IRS or state notices', 'N/A'),
